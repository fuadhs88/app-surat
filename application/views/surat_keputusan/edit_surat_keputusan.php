                ...
                <div class="col-md-10 mx-auto grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" action="<?= base_url('Surat_Keputusan/update_action') ?>" method="post" enctype="multipart/form-data">
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <input type="hidden" class="form-control" id="id" name="kode" value="<?= $kode; ?>" placeholder="kode" readonly>
                                    </div>
                                </div>
                                <div class="form-group row">
